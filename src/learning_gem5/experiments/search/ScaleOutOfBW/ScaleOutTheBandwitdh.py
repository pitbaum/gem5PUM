...
MMIO_SIZE = "64GiB"  # size of the MMIO window
...
for ch in range(CHANNELS_MMIO):
    ...
    ram = Ramulator2(
        config_path="ext/ramulator2/ramulator2/test_configurations/gem5_pum_max_bw.yaml",
...
# --------- SE workload ---------
binary = "src/learning_gem5/experiments/search/ScaleOutOfBW/a.out"
